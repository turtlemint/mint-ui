	...
	<svg width="1em" height="1em" viewBox="0 0 40 40" {...props}>
		<g fill="none" fillRule="evenodd">
			...
			<path
				fill="#CD3234"
				fillRule="nonzero"
				d="M11.217 19.992a.77.77 0 011.133 1.043c-2.016 2.19-4.251 2.19-6.268 0a.77.77 0 111.133-1.043c1.407 1.527 2.596 1.527 4.002 0zm21.568 0a.77.77 0 011.133 1.043c-2.017 2.19-4.252 2.19-6.268 0a.77.77 0 011.133-1.043c1.406 1.527 2.595 1.527 4.002 0z"
			/>
			<path
				fill="#CD3234"
				d="M11.714 32.174c5.195-2.31 10.588-2.31 16.179 0 .415-2.237-.381-4.265-2.389-6.082-3.813-2.845-7.648-2.845-11.507 0-2.018 2.01-2.78 4.038-2.283 6.082z"
			/>
			<path
				fill="#C03133"
