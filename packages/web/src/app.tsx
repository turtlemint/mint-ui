...
import PALETTE from "./components/__utils/colors";
			...
			<div className="text-center">
				<Row className="mb15">
					<Col>
						...
						Debitis accusamus, officiis provident consectetur, vero
						molestias dicta ab eaque tempora temporibus, non
						doloremque vel soluta minus aspernatur nostrum commodi
						voluptatibus animi.
					</Col>
				...
				<Row className="mb15">
					<Col md={4}>
						<Button btnType="outlined" onClick={() => {}}>
							Button Label
						</Button>
					</Col>
					<Col md={4}>
				...
				<Row className="mb15">
					...
					<Col sm={4} md={4} lg={4}>
						<Button disabled size="sm" onClick={() => {}}>
							Button Label
						</Button>
					</Col>
				</Row>
				...
				<Row className="mb15">
					<Col sm={6} md={6} lg={6}>
						<Button btnType="danger" href="#">
							Button Danger
						</Button>
					</Col>
					<Col sm={6} md={6} lg={6}>
						<Button btnType="danger" href="#" disabled>
							Button Danger
						</Button>
					</Col>
				</Row>
